# Codebase Assurance procedure coverage
...
| Get the real product running | [Establish the baseline](reproduce-path.md) | Client-readable baseline record and raw receipts | Pinned public consumer and acceptance machines |
...
| Make operations part of the claim | [Exercise operational failure](exercise-operations.md) | Failure and recovery receipts | Production operation remains explicitly unproven |
| Install the assurance gate | [Select, install, and prove the gate](install-gate.md) | Intervention and before/after proof | Public-interface conformance gate |
| Make the decision | [Make the bounded product decision](make-decision.md) | Sign-off and residual risk | Mixed result retained without blanket pass |
